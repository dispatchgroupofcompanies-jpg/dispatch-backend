  ...
  const html = `
    ...
    <head>
      ...
      <style>
        @page {
          size: A4;
          /* Proper margins for A4: top/bottom 15mm, left/right 20mm */
          margin: 15mm 20mm;
        }
        body { 
          margin: 0; 
    ...
    <body>
      ...
      <!-- 3. Carrier & Equipment Information -->
